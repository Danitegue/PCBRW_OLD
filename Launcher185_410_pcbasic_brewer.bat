...
%PYTHON_DIR%\python.exe %PCBASIC_PATH%\run.py --interface=sdl2 --mount=C:%MOUNT_C%,D:%MOUNT_D% --com1=PORT:%COM_PORT% --run=%PROGRAM% --quit=False -f=10 --shell=python %BRWFUNCT_DIR%\Brw_functions.py --logfile=%LOG_DIR%\pcbasic_brewer_log.txt
