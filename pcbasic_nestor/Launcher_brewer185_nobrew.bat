...
set PCBASIC_PATH=C:\PCBasic_Brewer_Repo\pcbasic_nestor
...
%PCBASIC_PATH%\ansipipe-launcher.exe %PYTHON_DIR%\python.exe %PCBASIC_PATH%\pcbasic.py --mount=C:%MOUNT_C%,D:%MOUNT_D% --interface=ansi --scaling=native --run=%PROGRAM% --quit=False -f=10 -s=128 --double=True --shell=native --logfile=C:\Temp\pcbasic_nestor_log.txt 
